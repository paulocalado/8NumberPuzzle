...
public class PuzzleChecker {
	...
	public static void checkChildrens(ArrayList<int[]> childrensList) {
		
		for(int[] children : childrensList) {
			
			if(visitedNodes.containsValue(children)) {
				System.out.println("nó já visitado");
				
			}else if(children == arrayAnswer) {
				System.out.println("Resposta encontrada! FIM");
				System.exit(0);
			}else {
				PuzzleControl.searchForZero(children);
			}
		}
